    ...
    return (
        <div id='about' className={styles.About}>
            ...
            <p className={styles.AboutText}>
                ...
                engaging and attractive web sites and web apps. As a new dad (Archer joined our tribe July 11th, 2019), My drive to learn and succeed has never been stronger, and I've found that
