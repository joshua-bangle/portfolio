    ...
    return (
        <div className={styles.About}>
            ...
            <p className={styles.AboutText}>
                ...
                my love and career for the last several years, and within the last year I discovered that my desire to create and my interest in coding were meant to come together in the form of building
                ...
                focused on picking up as much as I can get my hands on. Ruby on Rails is where I began, and as soon as JavaScript caught my eye, React.js has become my main focus.
            </p>
